...
with open(file_to_save, "w") as txt_file:
    ...
    # After printing final vote count to terminal, save final vote count to the text file.
    ...
    for candidate_name in candidate_votes:
        ...
        # Print each candidate's vote count and percentage of votes to the terminal.
